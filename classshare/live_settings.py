...
FORCE_SCRIPT_NAME = '/classshare'

DEBUG = True
TEMPLATE_DEBUG = DEBUG

ADMINS = (
    ('Karen Rustad', 'karen@ischool.berkeley.edu'),
    ('Rowyn McDonald', 'rowyn@ischool.berkeley.edu'),
    ('Monica Rosenberg', 'monica@ischool.berkeley.edu'),
)
...
DATABASES = {
    'default': {
        ...
        'NAME': 'classshare',
        'USER': 'classshare',                      # Not used with sqlite3.
        'PASSWORD': 'ht674s3',                  # Not used with sqlite3.
...
MEDIA_ROOT = '/groups/classshare/uploads/'
...
STATIC_URL = '/classshare/static/'

# URL prefix for admin static files -- CSS, JavaScript and images.
# Make sure to use a trailing slash.
# Examples: "http://foo.com/static/admin/", "/static/admin/".
ADMIN_MEDIA_PREFIX = '/classshare/static/admin/'
...
SECRET_KEY = 'pwta=ivo(w*ckxr*lppi6k+jp6-zf8_$mf8f---n)%s6)#8r4b'
